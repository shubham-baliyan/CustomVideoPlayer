...
function lol(e) {
  if(video.duration){
    ...
    console.log(Math.floor(loadStartPercentage*100),Math.floor(loadEndPercentage*100),Math.floor(loadPercentage));
  }
}
...
document.getElementById("volume").oninput = function() {
  ...
  this.style.background = 'linear-gradient(to right, #fff 0%, #fff ' + value + '%, #383233 ' + value + '%, #383233 100%)'
};
